...
const OrbitingLogos: FC<OrbitingLogosProps> = ({ className, children }) => {
  return (
    <div
      className={cn(
        'relative flex h-[400px] w-full max-w-[26rem] items-center justify-center overflow-hidden rounded-xl border border-[#00BCD4] bg-[radial-gradient(circle_at_50%_50%,_#D3D3D3_0%,_#696969_70%)] md:shadow-xl',
        className
      )}
    >
      <span className='pointer-events-none whitespace-pre-wrap bg-clip-text text-center text-8xl font-semibold leading-none text-[#FFFFFF]'>
        MT
      </span>

      {/* Orbits with branded icons */}
      <Orbit
